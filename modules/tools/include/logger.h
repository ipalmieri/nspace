...
class logObject
{
 public:
  ...
  static std::string formatMsgLong(const std::string& msg,
                                   const std::string& name,
                                   const logLevel& level);
  static std::string formatMsgShort(const std::string& msg,
                                    const std::string& name,
                                    const logLevel& level);
};
...
class logFile : public logObject
{
 public:
  ...
  void printMsg(const std::string& msg, const std::string& name,
                const logLevel& level);
...
class logSyslog : public logObject
{
 public:
  ...
  logSyslog(const int& facility=_LOGGER_DEFAC)
  {
    _facility = facility;
  }
  ~logSyslog() {}
...
class logger
{
 public:
  ...
  //helper functions
  inline logLevel intToLevel(const int& value);
