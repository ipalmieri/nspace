...
namespace neural
{
   ...
   class kneuron : public neuron
   {
     public:
      ...
      inline double positionX() const { return _pos.x; }
      inline double positionY() const { return _pos.y; }
      inline double positionZ() const { return _pos.z; }
      inline kposition getPosition() const { return _pos; }


      inline unsigned hits() const { return _hits; }
      inline void increaseHits() { _hits++; };
