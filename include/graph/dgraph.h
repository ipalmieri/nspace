...
template<typename N, typename E>  class dgraph
{
 public:
  ...
  inline void deleteNode(const nodeId& id)
  {
  ...
  dedge<N, E>* connectNodes(dnode<N, E>* inputn, dnode<N, E>* outputn,
                            const E prop)
  {
    dedge<N, E>* ret = NULL;
  ...
  inline typename dnode<N, E>::dnodeMap::const_iterator nodeMapBegin()
  {
    return _nodes.begin();
  }
  inline typename dnode<N, E>::dnodeMap::const_iterator nodeMapEnd()
  {
    return _nodes.end();
  }

  inline typename dedge<N, E>::dedgeMap::const_iterator edgeMapBegin()
  {
    return _edges.begin();
  }
  inline typename dedge<N, E>::dedgeMap::const_iterator edgeMapEnd()
  {
    return _edges.end();
  }
 ...
 protected:
  ...
  {
    static nodeId nextIdn = 0;
    return nextIdn++;
  }
  static edgeId nextEdgeId()
  {
    static edgeId nextIde = 0;
    return nextIde++;
  }
  inline void deleteEdge(const edgeId& id)
  {
    deleteEdge(getEdge(id));
  }
