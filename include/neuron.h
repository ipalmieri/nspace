...
class neuron
{
 public:
  ...
  inline tools::nodeId getNodeId()
  {
    return _node->id();
  }
  inline gnode* getNode()
  {
    return _node;
  }
  ...
  inline nsignal getOutput()
  {
    return _output;
  }


  inline void setGroup(const groupId& gid)
  {
    _gid = gid;
  }
  inline groupId getGroup()
  {
    return _gid;
  }
 ...
 protected:
  ...
  inline void setOutput(const nsignal& value)
  {
    _output = value;
  }
  inline void attachNode(gnode* node)
  {
    _node = node;
  }
